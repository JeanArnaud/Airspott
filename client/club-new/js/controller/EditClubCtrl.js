angular.module('com.airspott.club').controller('EditClubCtrl', [
    ...
    function ($rootScope, $stateParams, $scope, $log, $translate, $state, $q, Club, Upload, Message, Offer, Customer, TAX, Currency)
    {
        ...
        //
        // $scope.newoffer = Offer.findById({id : '5707894fb59396034f006523'});
        // $scope.newoffer.identifier = 'xyz';
        // $scope.newoffer.clubId = 'pqr';
        // $scope.newoffer.$save();

        // Offer.prototype$updateAttributes({
        //   'id':'56d7cb808426e74a55ceafde',
        //   'identifier':'Test134',
        //   'clubId':'Narola123'
        // });
        // Offer.deleteById({"id":'5707894fb59396034f006523'});
        // var data = {'id':'56d7cb808426e74a55ceafde','identifier':'Test1','clubId':'Narola1'};
        //
        // Offer.upsert(data, function(result)
        // {
        //     console.log('Updated data'+result);
        // });

       console.log(Offer.find({filter:{order : 'id desc',limit : 2}}));
